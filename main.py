...
# -*- coding: utf-8 -*-
device = torch.device("cuda")  # 明确指定使用 CPU
...
class Trainer(object):
    ...
    def train(self, epoch, data_loader):
        ...
        if label_result and pred_result:
...
if __name__ == '__main__':
    ...
    parser.add_argument('--config', type=str, default='./config/conll03.json')  # ← 添加 default
